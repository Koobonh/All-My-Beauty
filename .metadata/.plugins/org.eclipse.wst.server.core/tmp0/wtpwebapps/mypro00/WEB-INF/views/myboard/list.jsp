            ...
            <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">ALL MY BEAUTY</a>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <h2 class="module-title font-alt">문의 게시판</h2>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="panel panel-default">
										<div class="panel-heading" id="support"><h4>최근 문의된 사항</h4></div>
 									...
 									<div class="col-lg-12">
 										<div class="panel panel-default">
											 ...
											 <%-- 아래의 내용 전체 추가 --%>
												 ...
												 <div class="form-group">
 												<label>글 제목</label>
 												<input class="form-control" name="btitle" value=''/>
												 </div>
 												<div class="form-group">
	 												<label>글 내용</label>
												...
												<button class="btn btn-border-d btn-round" type="submit" id="registerBoard">등록</button>
											</div><%-- /.panel-body --%>
										</div><%-- /.panel --%>
									</div><%-- /.col-lg-12 --%>
								</div><%-- /.row --%>
