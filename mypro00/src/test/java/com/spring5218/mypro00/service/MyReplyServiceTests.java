...
//              myReplyService.getReplyListByBno(new MyReplyPagingDTO(114688, 1));
...
//      log.info(myReplyService.getReply(114688, 17L));
//  }
...
//
//      MyReplyVO myReply = myReplyService.getReply(114688, 17L);
//      if (myReply == null) {
//          return;
//      }
//
...
//      log.info("서비스-댓글 수정테스트: 수정 후 조회(수정된 myReplyVO): " + myReplyService.getReply(229404, 17L));
//  }
////  
//  //게시물에 대한 특정 댓글 삭제
//  @Test
//  public void testRemoveReply() {
//      log.info("서비스: 특정 게시물 삭제 테스트: " + myReplyService.removeReply(114688, 17L));
//}
