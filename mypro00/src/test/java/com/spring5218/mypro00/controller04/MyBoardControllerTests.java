package com.spring5218.mypro00.controller04;
...
//        log.info("resultPage 저장값: " + resultPage);
//    }
...
//                                 .get("/myboard/detailmod")  // /myboard/detail로 수정하여 테스트   //modify
//                                 .param("bno", "22"))
//                          .andReturn()
//                          .getModelAndView()
//                          .getModelMap());
...
//                                   .getModelAndView()
//                                   .getViewName();
//        log.info("=========resultPage 결과값: " + resultPage);
//    }
...
//        String resultPage = mockMvc.perform(MockMvcRequestBuilders
//                                           .post("/myboard/delete")
//                                           .param("bno", "5")  //5로 변경 후, 한 번 더 테스트 수행
//                                   .andReturn()
//                                   .getModelAndView()
//                                   .getViewName();
//        log.info("=========resultPage 결과값: " + resultPage);
