...
public interface MyReplyService {
	...
	//public List<MyReplyVO> getReplyListByBno(MyReplyPagingDTO myReplyPagingDTO);
	
	//특정 게시물에 대한 댓글 목록 조회(페이징2 - 수정)
	public MyReplyPagingCreatorDTO getReplyListByBno(MyReplyPagingDTO myReplyPagingDTO);

	//특정 게시물의 댓글 총 개수확인
	public long getReplyTotalByBno(MyReplyPagingDTO myReplyPagingDTO);
